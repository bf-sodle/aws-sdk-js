...
AWS.SharedIniFileCredentials = AWS.util.inherit(AWS.Credentials, {
   ...
   *   callback(err, token)
   * @option options roleSessionName [string] (role_session_name defined in ini file,
   *   or a generated value) Name of the STS Assume Role session
  ...
  constructor: function SharedIniFileCredentials(options) {
    ...
    this.roleSessionName = options.roleSessionName || null;
  ...
  loadRoleProfile: function loadRoleProfile(creds, roleProfile, callback) {
    ...
    var roleParams = {
      RoleArn: roleArn,
      RoleSessionName: this.roleSessionName || roleSessionName || 'aws-sdk-js-' + Date.now()
    };
